...
export default function Home() {
  return (
    <Layout>
      <Talk month="August" year= "2020" link="https://www.coursera.org/projects/creating-personal-site-gatsby" name="Coursera Guided Project" description= "Creating a Personal Site with Gatsby"/>      
