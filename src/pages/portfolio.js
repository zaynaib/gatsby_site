...
export default function Portfolio() {
  return (
    <Layout>
        ...
        <PortfolioLayout name = "Museum Map of Chicago"  description="An interactive map" webpage="https://wicked-labyrinth-31457.herokuapp.com/" github="https://github.com/zaynaib/map"/>
